...
LDFLAGS = -X 'wireflow/pkg/version.Version=$(WIREFLOW_VERSION)' \
          -X 'wireflow/pkg/version.GitCommit=$(GIT_COMMIT)' \
          -X 'wireflow/pkg/version.BuildTime=$(BUILD_TIME)' \
          -X 'wireflow/pkg/version.GoVersion=$(GO_VERSION)'
