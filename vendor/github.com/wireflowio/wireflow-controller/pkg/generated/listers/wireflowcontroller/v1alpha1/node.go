...
type NodeLister interface {
	...
	List(selector labels.Selector) (ret []*wireflowcontrollerv1alpha1.Node, err error)
...
type nodeLister struct {
	listers.ResourceIndexer[*wireflowcontrollerv1alpha1.Node]
}

// NewNodeLister returns a new NodeLister.
func NewNodeLister(indexer cache.Indexer) NodeLister {
	return &nodeLister{listers.New[*wireflowcontrollerv1alpha1.Node](indexer, wireflowcontrollerv1alpha1.Resource("node"))}
}

// Nodes returns an object that can list and get Nodes.
func (s *nodeLister) Nodes(namespace string) NodeNamespaceLister {
	return nodeNamespaceLister{listers.NewNamespaced[*wireflowcontrollerv1alpha1.Node](s.ResourceIndexer, namespace)}
}
...
type NodeNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*wireflowcontrollerv1alpha1.Node, error)
