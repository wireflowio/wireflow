...
type PolicyLister interface {
	...
	List(selector labels.Selector) (ret []*wireflowcontrollerv1alpha1.Policy, err error)
...
type policyLister struct {
	listers.ResourceIndexer[*wireflowcontrollerv1alpha1.Policy]
}

// NewPolicyLister returns a new PolicyLister.
func NewPolicyLister(indexer cache.Indexer) PolicyLister {
	return &policyLister{listers.New[*wireflowcontrollerv1alpha1.Policy](indexer, wireflowcontrollerv1alpha1.Resource("policy"))}
}

// Policies returns an object that can list and get Policies.
func (s *policyLister) Policies(namespace string) PolicyNamespaceLister {
	return policyNamespaceLister{listers.NewNamespaced[*wireflowcontrollerv1alpha1.Policy](s.ResourceIndexer, namespace)}
}
...
type PolicyNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*wireflowcontrollerv1alpha1.Policy, error)
