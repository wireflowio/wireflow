...
type RuleLister interface {
	...
	List(selector labels.Selector) (ret []*wireflowcontrollerv1alpha1.Rule, err error)
...
type ruleLister struct {
	listers.ResourceIndexer[*wireflowcontrollerv1alpha1.Rule]
}

// NewRuleLister returns a new RuleLister.
func NewRuleLister(indexer cache.Indexer) RuleLister {
	return &ruleLister{listers.New[*wireflowcontrollerv1alpha1.Rule](indexer, wireflowcontrollerv1alpha1.Resource("rule"))}
}

// Rules returns an object that can list and get Rules.
func (s *ruleLister) Rules(namespace string) RuleNamespaceLister {
	return ruleNamespaceLister{listers.NewNamespaced[*wireflowcontrollerv1alpha1.Rule](s.ResourceIndexer, namespace)}
}
...
type RuleNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*wireflowcontrollerv1alpha1.Rule, error)
